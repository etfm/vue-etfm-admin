...
const addRawReactionsMap = (target: any, key: PropertyKey, reaction: Reaction) => {
  ...
  if (reactionsMap) {
    ...
    const reactionsMap: ReactionsMap = new Map([[key, new ArraySet([reaction])]]);
    RawReactionsMap.set(target, reactionsMap);
    return reactionsMap;
  }
};

const addReactionsMapToReaction = (reaction: Reaction, reactionsMap: ReactionsMap) => {
