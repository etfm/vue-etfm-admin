<template>
  <etfma-popper ref="popperRef" :role="role">
    <etfma-tooltip-trigger
      :disabled="disabled"
      :trigger="trigger"
    ...
    >
      ...
      <etfma-popper-arrow v-if="showArrow" :arrow-offset="arrowOffset" />
    </etfma-tooltip-content>
  </etfma-popper>
</template>
...
<script lang="ts" setup>
  ...
  import EtfmaTooltipTrigger from './trigger.vue';
  import EtfmaTooltipContent from './content.vue';
  ...
  const controlled = computed(() => lodash.isBoolean(props.visible) && !hasUpdateHandler.value);
