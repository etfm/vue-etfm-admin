...
import { uniqueId, createElement } from '@elcplat/lowcode-shared'
import { TitleContent } from '@elcplat/lowcode-types'
import { WidgetContainer } from './widget-container'
import { getEvent } from '@elcplat/lowcode-shell'
import { PanelConfig, HelpTipConfig } from '../types'
import { TitledPanelView, TabsPanelView, PanelView } from '../components/widget'
...
export class Panel implements IWidget {
  ...
  constructor(readonly skeleton: Skeleton, readonly config: PanelConfig) {
    ...
    this.title = composeTitle(title || name, icon, description) as TitleContent
